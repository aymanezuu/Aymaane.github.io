...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    /* Hide GitHub Pages header/title */
    body > a:first-child,
    .page-header,
    .site-header,
    header {
    ...
    /* Heartbeat animation for the SVG heart */
    @keyframes heartbeat {
...
<body>
  ...
  <main class="card">
    ...
    <svg class="art" viewBox="0 0 320 240" xmlns="http://www.w3.org/2000/svg">
      ...
      <path class="heart-path" d="M250 50 C250 33 270 25 282 38
    ...
    <h1>Samah will you be my valentine?</h1>

    <section class="button-zone" id="zone">
      <button id="yesBtn" aria-label="Accept Valentine's invitation">Yes</button>
      <button id="noBtn" aria-label="Decline Valentine's invitation">No</button>
    </section>
    ...
    <section class="result" id="result">
      <h2>YAY! 🎉</h2>
      <p>I'm so happy! Can't wait to celebrate with you! 💕</p>
      <img
        class="fireworks"
        src="rick-roll-fireworks.gif"
        alt="Fireworks"
      />
    </section>
  </main>
